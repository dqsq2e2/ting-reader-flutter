...
class _LibraryEditorDialogState extends State<_LibraryEditorDialog> {
  ...
  Widget _buildLocalFields() {
    return Column(
      crossAxisAlignment: CrossAxisAlignment.stretch,
      children: [
        const _DialogLabel('选择本地路径（相对 storage/ 目录）'),
        const SizedBox(height: 8),
        Row(
          children: [
            Expanded(
